...
```text
https://ユーザー名.github.io/リポジトリ名/?v=28
```

共有ページ:

```text
https://ユーザー名.github.io/リポジトリ名/share.html?v=28
```
...
Shared links then use `share.html?v=28&id=...` and read the saved snapshot from the Worker.
