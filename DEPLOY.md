...
```text
https://ユーザー名.github.io/リポジトリ名/?v=29
```

共有ページ:

```text
https://ユーザー名.github.io/リポジトリ名/share.html?v=29
```
...
Shared links then use `share.html?v=29&id=...` and read the saved snapshot from the Worker.
