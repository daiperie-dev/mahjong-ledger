...
```text
https://ユーザー名.github.io/リポジトリ名/?v=35
```

共有ページ:

```text
https://ユーザー名.github.io/リポジトリ名/share.html?v=35
```
...
Shared links then use `share.html?v=35&id=...` and read the saved snapshot from the Worker.
