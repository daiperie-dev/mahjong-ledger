...
```text
https://ユーザー名.github.io/リポジトリ名/?v=38
```

共有ページ:

```text
https://ユーザー名.github.io/リポジトリ名/share.html?v=38
```
...
Shared links then use `share.html?v=38&id=...` and read the saved snapshot from the Worker.
