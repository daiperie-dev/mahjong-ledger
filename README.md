...
ブラウザで `http://localhost:5173/?v=26` を開きます。
...
`share.html?v=26` は読み取り専用の共有ページです。
...
The app can use an external Share API to store snapshots and send short `share.html?v=26&id=...` links.
